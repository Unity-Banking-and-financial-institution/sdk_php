 ...
 * @generated
 */
class RegistrySettingApiObject extends BunqModel
{
    /**
     * Field constants.
     */
    ...
    /**
     * @param string|null $color The color chosen for the Registry in hexadecimal format.
     * @param string|null $icon The icon chosen for the Registry.
     * @param string|null $defaultAvatarStatus The status of the avatar.
     * @param string|null $sddExpirationAction A monetaryAccountSetting field that should not be here, added for app support.
     */
