 ...
 * @generated
 */
class RegistryEntryReferenceObject extends BunqModel
{
    /**
    ...
    /**
     * @param string|null $type The object type that will be linked to the RegistryEntry.
     * @param int|null $id The ID of the object that will be used for the RegistryEntry.
     */
